...
† The deviation of $\ln(C_D)$ can be thought of as "the typical relative error in $C_D$". E.g., if the MAE of $\ln(C_D)$ is 0.051, you can think of it as "typically, drag is accurate to within roughly 5.1%".
